...
type FindAllData struct {
	...
	Items []*FindOneData `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
}

func (x *FindAllData) Reset() {
	*x = FindAllData{}
	if protoimpl.UnsafeEnabled {
...
func (x *FindAllData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FindAllData) ProtoMessage() {}

func (x *FindAllData) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_pb_product_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FindAllData.ProtoReflect.Descriptor instead.
func (*FindAllData) Descriptor() ([]byte, []int) {
	return file_pkg_pb_product_proto_rawDescGZIP(), []int{5}
}

func (x *FindAllData) GetItems() []*FindOneData {
	if x != nil {
		return x.Items
	}
	return nil
...
type FindAllResponse struct {
	...
	Status int64        `protobuf:"varint,1,opt,name=status,proto3" json:"status,omitempty"`
	Error  string       `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
	Data   *FindAllData `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
}
...
func (x *FindAllResponse) GetData() *FindAllData {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_pkg_pb_product_proto_rawDesc = []byte{
	...
	0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x39, 0x0a, 0x0b, 0x46, 0x69,
	0x6e, 0x64, 0x41, 0x6c, 0x6c, 0x44, 0x61, 0x74, 0x61, 0x12, 0x2a, 0x0a, 0x05, 0x69, 0x74, 0x65,
	0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x75,
	0x63, 0x74, 0x2e, 0x46, 0x69, 0x6e, 0x64, 0x4f, 0x6e, 0x65, 0x44, 0x61, 0x74, 0x61, 0x52, 0x05,
	0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x10, 0x0a, 0x0e, 0x46, 0x69, 0x6e, 0x64, 0x41, 0x6c, 0x6c,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x69, 0x0a, 0x0f, 0x46, 0x69, 0x6e, 0x64, 0x41,
	...
	0x2e, 0x46, 0x69, 0x6e, 0x64, 0x41, 0x6c, 0x6c, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xb4, 0x02, 0x0a, 0x0e,
...
var file_pkg_pb_product_proto_goTypes = []interface{}{
	...
	(*FindAllData)(nil),           // 5: product.FindAllData
...
var file_pkg_pb_product_proto_depIdxs = []int32{
	...
	2, // 1: product.FindAllData.items:type_name -> product.FindOneData
	5, // 2: product.FindAllResponse.data:type_name -> product.FindAllData
	...
	8, // 6: product.ProductService.DecreaseStock:input_type -> product.DecreaseStockRequest
	1, // 7: product.ProductService.CreateProduct:output_type -> product.CreateProductResponse
	4, // 8: product.ProductService.FindOne:output_type -> product.FindOneResponse
	7, // 9: product.ProductService.FindAll:output_type -> product.FindAllResponse
	9, // 10: product.ProductService.DecreaseStock:output_type -> product.DecreaseStockResponse
